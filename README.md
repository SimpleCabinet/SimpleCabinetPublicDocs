...
Документация к SimpleCabinet 2. Все компоненты SimpleCabinet после релиза будут доступны под лицензией MIT с открытым исходным кодом.
 ...
 - [x] **Вторая стадия релиза**: Релиз плагина для Fabric.
...
- [SimpleCabinetIntegrations](https://github.com/SimpleCabinet/SimpleCabinetIntegrations) - Плагин Bukkit 1.7 - 1.17+ и мод Fabric 1.20+, добавляющий команды `/shop` и `/economy` для получения предметов и торговли
